...
(defconst lse_fill-in_head_delim_chars       "«Š")
(defconst lse_fill-in_tail_delim_chars       "Š»·")
...
(defconst lse_no_replacement_fill-in_marker  "Š")
(defconst lse_list_fill-in_trailer           "···")

;;; take care of characters which must be quoted inside Emacs patterns!!!
(defconst lse_req_fill-in_head_delim_pattern "«Š?")
(defconst lse_req_fill-in_tail_delim_pattern "Š?»")
(defconst lse_opt_fill-in_head_delim_pattern "««Š?")
(defconst lse_opt_fill-in_tail_delim_pattern "Š?»»")
